...
# Customize message tags (for example, to use different tags for each level)
# settings.py (optional for customizing message tags)
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'wahabsardar130@gmail.com'
EMAIL_HOST_PASSWORD = 'fiuz pkrx qztl dtau'
